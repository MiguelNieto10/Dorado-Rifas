...
export function welcomeText(username) {
  ...
  return [
    ...
    "",
    "El premio de cada tablero es el 50% de lo que se recaude en ese tablero. El otro 50% es de la casa. Siempre hay un ganador, pero solo entre los números que estén en verde y pagos. Un número amarillo (reservado) o sin pagar no entra al sorteo.",
    "",
    ...
    "",
    "3. Me envías el comprobante a un administrador, en el grupo de WhatsApp. Si no llega el comprobante, ese número se libera a los 15 minutos y otra persona puede tomarlo. Cuando el administrador confirma, el número pasa a verde y queda asegurado: ya no se suelta y sí entra al sorteo.",
    "",
    "4. En el sorteo solo participan los números verdes y pagos. El premio es el 50% de lo recaudado en ese tablero. Si tu número no está en verde, no puedes ganar ese sorteo.",
    "",
    ...
    "",
    "6. A los 10 segundos el tablero se abre otra vez, con los números disponibles. Puedes dejar el saldo para jugar otro tablero o retirarlo a Nequi.",
    "",
        ...
        <table role="presentation" width="560" cellspacing="0" cellpadding="0" style="max-width:560px;width:100%;background:#15171e;border:1px solid #8a713a;border-radius:20px;">
          <tr>
            <td style="padding:36px 32px 8px;text-align:left;">
              ...
              <p style="${p}">El premio de cada tablero es el <strong style="color:#e8c877;">50% de lo que se recaude</strong> en ese tablero. El otro 50% es de la casa. Siempre hay un ganador, pero <strong style="color:#efe8d8;">solo entre los números que estén en verde y pagos</strong>. Un número amarillo (reservado) o sin pagar no entra al sorteo.</p>
              ...
              ${ruleBlock("3", "Me envías el comprobante a un administrador, en el grupo de WhatsApp. Si no llega el comprobante, ese número se libera a los 15 minutos y otra persona puede tomarlo. Cuando el administrador confirma, el número pasa a verde y queda asegurado: ya no se suelta y sí entra al sorteo.")}
              ${ruleBlock("4", "En el sorteo solo participan los números verdes y pagos. El premio es el 50% de lo recaudado en ese tablero. Si tu número no está en verde, no puedes ganar ese sorteo.")}
              ...
              ${ruleBlock("6", "A los 10 segundos el tablero se abre otra vez, con los números disponibles. Puedes dejar el saldo para jugar otro tablero o retirarlo a Nequi.")}
